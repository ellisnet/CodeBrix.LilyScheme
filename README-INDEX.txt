================================================================================
README-INDEX: CodeBrix.LilyScheme
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.LilyScheme.LgplLicenseForever — a managed, cross-platform Scheme
      language implementation for .NET, derived from GNU Guile: full syntax-case
      macro expansion, the module system, GOOPS, the numeric tower, ports, a
      POSIX surface, and the host API for embedding it in a .NET application.

MAINTAINER AND EXTRAS
---------------------
  MAINTAINER-README.txt
      Building, testing, packaging, versioning and provenance notes for
      maintainers, plus the port's Guile-fidelity and measured-divergence record.
  EXTRAS-README.txt
